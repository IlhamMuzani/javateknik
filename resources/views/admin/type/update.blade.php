        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Perbarui Type</h3>
                </div>
                <!-- /.card-header -->
                                    ...
                                    <select class="select2bs4 select2-hidden-accessible" name="merek_id"
                                        ...
                                        @foreach ($mereks as $merek)
                                            <option value="{{ $merek->id }}"
                                                {{ old('merek_id', $type->merek_id) == $merek->id ? 'selected' : '' }}>
                                                {{ $merek->nama_merek }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input readonly class="form-control @error('kode_merek') is-invalid @enderror"
                                        ...
                                        value="{{ old('kode_merek', $type->merek->kode_merek ?? null) }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_type" name="nama_type"
                                placeholder="Masukan nama type" value="{{ old('nama_type', $type->nama_type) }}">
                        </div>
                    </div>
