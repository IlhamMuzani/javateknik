...
<body style="margin: 0; padding: 0;">
    ...
    <div style="text-align: center;">
        ...
        <span style=" font-size: 15px;">Jl. Ahmad Yani No. 42 Procot Slawi, <br>
            Tegal 52411</span>
        <br>
        <span style=" font-size: 15px;">Telp, (0283) 4563746</span>
    </div>
    <hr style="border: 1px solid;">
    <div style="text-align: center;">
        <span style="font-weight: bold; font-size: 20px; text-decoration: underline;">PURCHASE ORDER</span>
    </div>
    <table style="width: 100%; margin-bottom:5px">
        <tr>
            ...
            <td style="text-align: right; padding-right: 45px;">
                <span class="info-item" style="font-size: 15px;">Tegal, {{ $pembelians->tanggal }}</span>
                <br>
            </td>
        </tr>
    </table>
    ...
    <div style="display: flex; justify-content: left; align-items: left; margin-top:30px">
        <table style="text-align: letf;">
            ...
            <tr>
                <td style="font-size: 15px; font-weight: lighter; font-weight:bold">
                    {{ $pembelians->supplier->nama_supp }}</td>
            </tr>
            <tr>
                <td style="font-size: 15px; font-weight: lighter; max-width: 200px; word-wrap: break-word;">
    ...
    <div style="display: flex; justify-content: left; align-items: left; margin-top:30px">
        <table style="text-align: letf;">
            <tr>
                <td style="font-size: 15px; font-weight: lighter;">Dengan Hormat,</td>
            </tr>
        </table>
    </div>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top:10px;" cellpadding="2" cellspacing="0"
        ...
        {{-- <tr>
            <td colspan="6"
                ...
                Sub Total</td>
            <td class="td"
                style="text-align: left; font-weight: bold; padding: 5px; font-size: 15px; border: 1px solid black;">
    ...
    <div>
        ...
        <br>
        <br>
        <p style="font-size: 15px; text-align: left; text-decoration: underline;">Djohan Wahyudi</p>
        <p style="font-size: 15px; text-align: left;">Direktur</p>
    </div>
</body>

<div class="container">
    <a href="{{ url('admin/inquery_popembelian') }}" class="blue-button">Kembali</a>
