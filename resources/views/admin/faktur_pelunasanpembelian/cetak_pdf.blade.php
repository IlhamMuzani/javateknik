...
<head>
    ...
    <title>Pelunasan Faktur Pembelian</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    <table cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td style="text-align: left; font-size: 13px;">
                <span class="content2">
                    {{ $cetakpdf->nama_supplier }}
                </span>
                <br>
            </td>
        </tr>
        <tr>
            <td class="info-text info-left" style="font-size: 13px;">Jl. Ahmad Yani No. 42 Procot Slawi,
                {{-- <br>
                SLAWI TEGAL <br>
            ...
            <td style="text-align: left; font-size: 13px;">
                <span class="content2">
                    {{ $cetakpdf->alamat_supplier }}
                </span>
                <br>
            </td>
        </tr>
        <tr>
            <td class="info-text info-left" style="font-size: 13px;">Tegal 52411
            </td>
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 20px;">PELUNASAN FAKTUR PEMBELIAN</span>
        <br>
    </div>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 13px;">F. Pembelian</td>
            <td class="td" style="text-align: center; padding: 5px; font-size: 13px;">Tanggal Pembelian</td>
        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="td" style="text-align: center;  font-size: 13px;">{{ $item->kode_pembelian }}</td>
        ...
        <tr>
            ...
            <td style="width: 70%;">
                <table style="width: 100%;" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left; padding: 0px; font-size: 13px;">Tambahan
                            Pembayaran
                        </td>
                        <td class="td" style="text-align: right; font-size: 13px;">
