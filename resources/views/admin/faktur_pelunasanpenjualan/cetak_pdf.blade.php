...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 20px;">PELUNASAN FAKTUR PENJUALAN</span>
        <br>
    </div>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 13px;">Tanggal Penjualan</td>
        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="td" style="text-align: center;  font-size: 13px;">{{ $item->kode_penjualan }}</td>
