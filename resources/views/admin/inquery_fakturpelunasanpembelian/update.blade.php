...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_fakturpelunasanpembelian') }}">Inquery
                                pelunasan Faktur Pembelian</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery-pelunasan-pembelian/' . $inquery->id) }}" method="POST"
                enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Perbarui Pelunasan Faktur Pembelian</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pelunasan Faktur Pembelian <span>
                            </span></h3>
                                ...
                                @foreach ($details as $detail)
                                    <tr id="pembelian-{{ $loop->index }}">
                                        ...
                                        <td hidden>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    id="pembelian_id-{{ $loop->index }}" name="pembelian_id[]"
                                                    value="{{ $detail['pembelian_id'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input onclick="MemoEkspedisi({{ $loop->index }})"
                                                    ...
                                                    id="kode_pembelian-{{ $loop->index }}"
                                                    name="kode_pembelian[]"
                                                    value="{{ $detail['kode_pembelian'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
    ...
    <script>
        ...
        function itemPembelian(identifier, key, value = null) {
            ...
            item_pembelian += '<input type="text" class="form-control" id="pembelian_id-' + key +
                '" name="pembelian_id[]" value="' +
                pembelian_id +
                '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
    ...
    <script>
        ...
        function getFaktur(rowIndex) {
            ...
            var kode_pembelian_ban = selectedRow.data('kode_pembelian');
