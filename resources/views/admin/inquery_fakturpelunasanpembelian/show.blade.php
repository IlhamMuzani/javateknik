...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">PELUNASAN FAKTUR PEMBELIAN</span>
        <br>
    </div>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 15px;">F. Pembelian</td>
            <td class="td" style="text-align: center; padding: 5px; font-size: 15px;">Tanggal Pembelian</td>
        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="td" style="text-align: center;  font-size: 15px;">{{ $item->kode_pembelian }}</td>
...
<div class="container">
    <a href="{{ url('admin/inquery-pelunasan-pembelian') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/pelunasan-pembelian/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
</body>
