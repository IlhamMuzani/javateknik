            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        @if (auth()->user()->menufiturs()->where('nama', 'Data Satuan')->wherePivot('can_create', 1)->exists())
                            ...
                            @foreach ($satuans as $satuan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if (auth()->user()->menufiturs()->where('nama', 'Data Satuan')->wherePivot('can_update', 1)->exists())
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Yakin hapus satuan <strong>{{ $satuan->nama_satuan }}</strong>?</p>
                                            </div>
