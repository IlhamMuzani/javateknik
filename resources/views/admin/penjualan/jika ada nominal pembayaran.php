                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4 offset-md-8">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: right" type="text" class="form-control" id="sub_total"
                            ...
                            <div class="col-md-4 offset-md-8">
                                <div class="form-group">
                                    ...
                                    <div id="error-nominal" class="text-danger mt-1" style="font-size: 0.9em;"></div>
                                </div>
                            </div>
                            <div class="col-md-4 offset-md-8">
                                <hr
                        ...
                        <tbody>
                            @foreach ($barangs as $barang)
                                <tr data-barang_id="{{ $barang->id }}"
                                    ...
                                    <td>{{ $barang->nama_barang }}</td>
                                    <td>{{ $barang->merek->nama_merek ?? null }}</td>
                                    <td class="harga_a">{{ number_format($barang->harga->first()->harga_a, 0, ',', '.') }}
                                    </td>
                                    <td class="harga_b">{{ number_format($barang->harga->first()->harga_b, 0, ',', '.') }}
                                    </td>
                                    <td class="harga_c">{{ number_format($barang->harga->first()->harga_c, 0, ',', '.') }}
                                    </td>
                                    <td class="harga_d">{{ number_format($barang->harga->first()->harga_d, 0, ',', '.') }}
                                    </td>
                                    <td class="harga_e">{{ number_format($barang->harga->first()->harga_e, 0, ',', '.') }}
                                    </td>
                                    <td>
    ...
    <script>
        $(document).ready(function() {
            $('form').on('submit', function(e) {
                ...
                if (pelangganName !== "" && barangValid && nominalValid) {
