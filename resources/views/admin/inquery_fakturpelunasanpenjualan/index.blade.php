...
@section('content')
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($fakturpelunasan->status == 'unpost')
                                                @if (auth()->user()->menufiturs()->where('nama', 'Inquery Pelunasan Penjualan')->wherePivot('can_posting', 1)->exists())
                                                    <a class="dropdown-item posting-btn"
                                                        data-memo-id="{{ $fakturpelunasan->id }}">Posting</a>
                                                @endif
                                                @if (auth()->user()->menufiturs()->where('nama', 'Inquery Pelunasan Penjualan')->wherePivot('can_update', 1)->exists())
                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/inquery-pelunasan-penjualan/' . $fakturpelunasan->id . '/edit') }}">Update</a>
                                                @endif
                                                @if (auth()->user()->menufiturs()->where('nama', 'Inquery Pelunasan Penjualan')->wherePivot('can_show', 1)->exists())
                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/inquery-pelunasan-penjualan/' . $fakturpelunasan->id) }}">Show</a>
                                                @endif
                                                @if (auth()->user()->menufiturs()->where('nama', 'Inquery Pelunasan Penjualan')->wherePivot('can_delete', 1)->exists())
                                            ...
                                            @endif
                                            @if ($fakturpelunasan->status == 'posting')
                                                @if (auth()->user()->menufiturs()->where('nama', 'Inquery Pelunasan Penjualan')->wherePivot('can_unpost', 1)->exists())
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery-pelunasan-penjualan') }}";
            form.submit();
        }
    </script>
