...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/bagian') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="nama_bagian">Nama Bagian *</label>
                            <input class="form-control @error('nama_bagian') is-invalid @enderror" id="nama_bagian"
                                name="nama_bagian" type="text" placeholder="masukan nama bagian"
