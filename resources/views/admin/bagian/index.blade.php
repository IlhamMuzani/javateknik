                        ...
                        <tbody>
                            @foreach ($bagians as $bagian)
                                <tr>
                                    ...
                                    <td>{{ $bagian->merek->nama_merek ?? null }}</td>
                                    <td data-toggle="modal" data-target="#modal-qrcode-{{ $bagian->id }}"
                                    ...
                                    <td class="text-center">
                                        ...
                                        @endif
                                        @if (auth()->user()->menufiturs()->where('nama', 'Data Bagian')->wherePivot('can_delete', 1)->exists())
                                            <button type="submit" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modal-hapus-{{ $bagian->id }}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Yakin hapus bagian <strong>{{ $bagian->nama_type }}</strong>?</p>
                                            </div>
                                ...
                                <div class="modal fade" id="modal-qrcode-{{ $bagian->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <div style="text-align: center;">
                                                    <p style="font-size:20px; font-weight: bold;">
                                                        {{ $bagian->kode_bagian }}</p>
                                                    <div style="display: inline-block;">
                                                        {!! DNS2D::getBarcodeHTML("$bagian->qrcode_bagian", 'QRCODE', 15, 15) !!}
                                                    </div>
                                                    <p style="font-size:20px; font-weight: bold;">
                                                        {{ $bagian->nama_lengkap }}</p>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-default"
                                                        data-dismiss="modal">Batal</button>
                                                    <a href="{{ url('admin/bagian/cetak-pdf/' . $bagian->id) }}"
