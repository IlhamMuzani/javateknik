...
@section('title', 'Laporan Pelunasan Faktur Penjualan Global')
...
@section('content')
    ...
    <div class="content-header">
        {{-- <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Pelunasan Faktur Penjualan Global</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Pelunasan Faktur Penjualan Global</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid --> --}}
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Pelunasan Faktur Penjualan Global</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporan-pelunasan-penjualan-global') }}";
            form.submit();
        }
        ...
        function printReport() {
            ...
            if (startDate && endDate) {
                form.action = "{{ url('admin/print-pelunasan-penjualan-global') }}" + "?start_date=" + startDate +
                    "&end_date=" +
                    endDate;
                form.submit();
            } else {
