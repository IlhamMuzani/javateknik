...
<head>
    ...
    <title>Laporan Pelunasan Faktur Penjualan</title>
    <style>
        html,
        body {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 18PX;">LAPORAN PELUNASAN FAKTUR PENJUALAN - RANGKUMAN</span>
        <br>
        <div class="text">
            @php
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 12px;">Potongan</td>
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 12px;">Tambahan</td>
        ...
        @foreach ($inquery as $faktur)
            <tr>
                ...
                <td class="td" style="text-align: right; padding: 5px; font-size: 12px;">
                    {{ number_format($faktur->potongan, 0, ',', '.') }}
                </td>
                <td class="td" style="text-align: right; padding: 5px; font-size: 12px;">
                    {{ number_format($faktur->ongkos_bongkar, 0, ',', '.') }}
                </td>
                <td class="td" style="text-align: right; padding: 5px; font-size: 12px;">
                    {{ number_format($faktur->totalpembayaran, 0, ',', '.') }}
                </td>
        ...
        @endforeach
        <tr>
            <td colspan="7" style="text-align: right; font-weight: bold; padding: 5px; font-size: 12px;">Sub Total
            </td>
