        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <img src="{{ asset('storage/uploads/gambar_logo/login.png') }}" alt="JavaTeknik" height="80"
                        width="170">
                </li>
            </ul>
        </nav>
            ...
            <a href="" class="brand-link d-flex align-items-center">
                @if (auth()->user()->karyawan)
                    @if (auth()->user()->karyawan->gambar)
                        <img src="{{ asset('storage/uploads/' . auth()->user()->karyawan->gambar) }}" alt="JavaTeknik"
                            class="brand-image rounded-circle">
                    @else
                        <img src="{{ asset('storage/uploads/gambar_logo/user.png') }}" alt="JavaTeknik"
                            class="brand-image">
                    @endif
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Yakin keluar sistem <strong>Sistem Java Teknik</strong>?</p>
                    </div>
